...
* i3start is the startup script used by the login manager. It's called by custom-i3.desktop.
* i3status_custom_bar is an  extension script for i3bar. It adds infos to i3status output.
